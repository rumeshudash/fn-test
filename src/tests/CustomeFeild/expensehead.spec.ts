...
test.describe('Configurations-Custom Feilds', () => {
    PROCESS_TEST('TCF001- Expense Head -Negative', async ({ page }) => {
        ...
        await PROCESS_TEST.step('Check Expense Head Tab', async () => {
            await customefeild.clickOnTab('Expense Head');
        });
    ...
    PROCESS_TEST(
        ...
        async ({ page }) => {
            ...
            await PROCESS_TEST.step(
                'Add Expense Head With Text Type',
                async () => {
                    await customefeild.clickOnTab('Expense Head');
            ...
            await PROCESS_TEST.step(
                'Add Expense Head With Number type',
                async () => {
                    await customefeild.clickButton('Add New');
                    await customefeild.addWithTextType(
                        name + 'abce',
            ...
            await PROCESS_TEST.step(
                'Add Expense Head With Date type',
                async () => {
                    await customefeild.clickButton('Add New');
            ...
            await PROCESS_TEST.step(
                'Add Expense Head With TextArea',
                async () => {
                    await customefeild.clickButton('Add New');
                    await customefeild.addWithTextType(
                        name + 'abcg',
